...
urlpatterns = [
    ...
    # path("password-reset-confirm/<uidb64>/<token>/", auth_views.PasswordResetConfirmView.as_view(success_url=reverse_lazy("users:login"), template_name="users/password_reset_confirm.html"), name="password_reset_confirm"),
